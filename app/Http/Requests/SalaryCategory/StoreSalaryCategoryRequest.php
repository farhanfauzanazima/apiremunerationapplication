...
class StoreSalaryCategoryRequest extends FormRequest
{
    ...
    {
        return [
            'category_name' => 'required|string|max:50|unique:salary_categories,category_name',
    ...
    public function messages(): array
    {
        return [
            ...
            'overtime_rate.numeric'  => 'Rate lembur harus berupa angka.',
            'late_penalty.numeric'   => 'Potongan keterlambatan harus berupa angka.',
        ];
    }
}